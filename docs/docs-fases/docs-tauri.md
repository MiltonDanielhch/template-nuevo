...
| **4** | **Ejemplo Práctico 3026** | **Comando de inicialización:** <br> ```bash bunx tauri init ``` <br> **Configuración en `tauri.conf.json`:** <br> ```json { "build": { "devPath": "http://localhost:4321", "distDir": "../dist" } } ``` |
