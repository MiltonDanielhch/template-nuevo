...
| 3 | Role Sync | `presentation/pages/users.astro`: Carga de roles reales desde el backend RBAC. | ✅ |
| 4 | Settings Page | `presentation/pages/settings.astro`: Gestión de perfil (email, pass, user). | ✅ |
